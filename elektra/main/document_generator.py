...
from .models import GeneratedTest, Theme, School
from .dzi_test import generate_test
from .MakeDocs import make_test_doc, make_key_doc


def generate_test_and_key(theme_id, school_id):
    """
    ...
    try:
        ...
        test_path = make_test_doc(test_data, template_path=test_template_path, output_filename=test_output_path)
        key_path = make_key_doc(test_data, template_path=key_template_path, output_filename=key_output_path)
